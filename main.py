...
fontList = [
    "Noto Sans Adlam 2019",
    "Noto Sans Adlam 2019 Bold",
    "Noto Sans Adlam 2017",
    "Adlam CWC",
    "Aissata Unicode",
...
kb_list = [
    {"shortName": "ff_adlam", "longName": "Fulfulde Adlam"},
]
...
class langInfo:
    def __init__(self):
        ...
        if sys.maxunicode >= 0x10000:
            ...
            self.diacritic_list = [
                chr(0xD83A) + chr(0xDD00 + x) for x in range(0x44, 0x4B)
            ]
            self.base_consonant = "\ud83a\udd0e"
    ...
    def __init__(self, v):
        ...
        if sys.maxunicode <= 65535:
            ...
            if self.charType == "Mn":
                # Punctuation
                self.unicodeChar = (
                    chr(0x20) + chr(0xA0) + chr(v - 0x1E900 + 0xDD00) + " "
                )
            else:
        ...
        if v in convert.reverseConvert:
            ...
            if v - 0x22 in convert.reverseConvert:
                self.pulaarCode = convert.reverseConvert[v - 0x22]
                # For lower case
            else:
                self.pulaarCode = 0
